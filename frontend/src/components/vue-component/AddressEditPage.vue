<template>
  <form class="address-edit-tab-body" @submit="validateAndSubmitUpdateAddress">
    ...
    <div class="row mb-4 mx-5">
      <label for="address-edit-phone" class="col-sm-3 col-form-label"
        >Điện thoại</label
      >
      <div class="col-sm-9">
        <input
    ...
    <div class="row mb-4 mx-5">
      <label for="address-edit-country" class="col-sm-3 col-form-label"
        >Quốc gia</label
      >
      <div class="col-sm-9">
        <input
    ...
    <div class="row mb-4 mx-5">
      <label for="address-edit-city" class="col-sm-3 col-form-label"
    ...
    <div class="row mb-4 mx-5">
      <label for="address-edit-district" class="col-sm-3 col-form-label"
        >Quận/Huyện</label
      >
      <div class="col-sm-9">
        <input
    ...
    <div class="row mb-4 mx-5">
      <label for="address-edit-ward" class="col-sm-3 col-form-label"
        >Xã/Phường</label
      >
      <div class="col-sm-9">
        <input
    ...
    <div class="row mb-4 mx-5">
      <label for="address-edit-stAddress" class="col-sm-3 col-form-label"
        >Địa chỉ</label
      >
      <div class="col-sm-9">
        <input
...
<script>
import "../css-component/address-edit-tab.css";
...
export default {
  ...
  data() {
    return {
      id_address: this.$route.query.id_address,
      ...
      district: this.$route.query.district || null,
      ward: this.$route.query.ward || null,
      stAddress: this.$route.query.address || null,
      nameErr: "",
      phoneErr: "",
      countryErr: "",
      cityErr: "",
